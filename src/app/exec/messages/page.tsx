    ...
    <div className="h-[calc(100vh-4rem)] flex flex-col">
      <div className="flex-1 container mx-auto max-w-7xl px-4 py-8 overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row h-full w-full overflow-x-hidden">
          ...
          <div className={`w-full lg:w-80 rounded-lg border border-gray-800 bg-gray-900/50 backdrop-blur-sm overflow-hidden mb-4 lg:mb-0 ${activeMobileSection !== 'deals' ? 'hidden lg:block' : ''}`}>
          ...
          <div className="flex flex-col lg:flex-row flex-1 w-full">
            {/* Chat section */}
            <div className={`w-full lg:flex-1 rounded-lg border border-gray-800 bg-gray-900/50 backdrop-blur-sm overflow-hidden mb-4 lg:mb-0 lg:ml-6 ${activeMobileSection !== 'chat' ? 'hidden lg:block' : ''}`}>
              {selectedDeal ? (
            ...
            <div className={`w-full lg:w-96 rounded-lg border border-gray-800 bg-gray-900/50 backdrop-blur-sm overflow-hidden lg:ml-6 ${activeMobileSection !== 'details' ? 'hidden lg:block' : ''}`}>
              {selectedDeal ? (
