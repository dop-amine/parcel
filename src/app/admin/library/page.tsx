...
import { Play, Pause, Heart, ShoppingCart, Plus, Trash2, Shield } from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen bg-gray-950">
      ...
      <header className="w-full px-8 py-6 flex items-center justify-between border-b border-gray-800 bg-black/60 sticky top-0 z-20">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-3xl font-extrabold text-white tracking-tight">Admin Library</h1>
        </div>
      ...
      <div className="flex flex-1 w-full max-w-7xl mx-auto mt-6 gap-8 px-4">
        ...
        <aside className="w-80 min-w-[220px] max-w-xs flex-shrink-0">
          <div className="mb-6">
            <h2 className="text-xl font-semibold text-gray-200 mb-4">Admin Playlists</h2>
        ...
        <main className="flex-1 flex flex-col gap-6">
          {selectedLiked ? (
              ...
              <div className="flex items-center gap-6 mb-6 sticky top-0 z-10 bg-black/30 py-4 rounded-xl">
                ...
                <div className="flex-1 min-w-0">
                  <input
                    ...
                    value="Admin Liked Songs"
                    disabled
                  />
                  <div className="text-gray-300 text-base mt-2">Your favorite tracks as admin.</div>
                </div>
              </div>
              <div className="mt-4">
              ...
              <div className="flex items-center gap-6 mb-6 sticky top-0 z-10 bg-black/30 py-4 rounded-xl">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 mt-2">
                    ...
                    <span className="px-2 py-0.5 rounded bg-green-900/50 text-green-400 text-xs">ADMIN</span>
                  </div>
                </div>
            ...
            <div className="flex flex-col items-center justify-center h-full text-gray-400">
              ...
              <h3 className="text-xl font-semibold mb-2">Admin Library</h3>
              <p className="text-center">Select a playlist to view details or create a new one.</p>
            </div>
          )}
        </main>
      </div>

      {/* Modals - Same as exec/library but with admin context */}
      ...
      <Dialog open={isCreateModalOpen} onOpenChange={setIsCreateModalOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Give your admin playlist a name.</DialogDescription>
          </DialogHeader>
